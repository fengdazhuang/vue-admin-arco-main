    ...
    <a-card class="general-card" :title="$t('menu.list.searchTable')">
            ...
            <a-modal width="800px" v-model:visible="visible" @cancel="handleCancel" @ok="$refs.formRef.resetFields()"  unmountOnClose>
              ...
              <div>
                <a-form ref="formRef" :size="form.size" :model="form" :style="{width:'600px'}" @submit="handleSubmit">
                    ...
                    <a-form-item field="password" label="设置密码"
                                 :rules="[{required:true,message:'password is required'},{minLength:6,message:'密码不能少于6位'}]"
                                 :validate-trigger="['change','input']"
                    >
                      <a-input v-model="form.password" placeholder="请设置密码" />
                    </a-form-item>
                    ...
                    <a-form-item field="treeSelect" label="管理项目">
                      <a-tree-select :data="treeData" v-model="form.treeSelect" placeholder="请选择要管理的项目"/>
                    </a-form-item>
                    <a-form-item>
                      <a-space>
      ...
      >
        <template #columns>
          ...
          <a-table-column
            :title="$t('searchTable.columns.filterType3')"
